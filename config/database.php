...
|--------------------------------------------------------------------------
| Connection definitions for the supported drivers. This project uses the
| MySQL connection by default (see .env DB_* values).
*/
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                // PDO::MYSQL_ATTR_SSL_CA was deprecated in PHP 8.5.
